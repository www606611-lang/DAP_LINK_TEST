...
#define YAW_CONTROL_DT_CLAMP_MS         40U
#define YAW_CONTROL_DEADBAND_DEG        1.0f
#define YAW_CONTROL_SOFT_ZONE_DEG       3.0f
#define YAW_CONTROL_MAX_TURN_SPEED_PPS  900.0f
#define YAW_CONTROL_MIN_TURN_SPEED_PPS  0.0f
#define YAW_CONTROL_INTEGRAL_LIMIT      60.0f
#define YAW_CONTROL_LEFT_FORWARD_MIN_PWM 0.0f
#define YAW_CONTROL_LEFT_REVERSE_MIN_PWM 0.0f
#define YAW_CONTROL_RIGHT_FORWARD_MIN_PWM 0.0f
#define YAW_CONTROL_RIGHT_REVERSE_MIN_PWM 0.0f
#define YAW_CONTROL_MIN_DRIVE_REF_PPS   0.0f
#define YAW_CONTROL_SIGN                1.0f
#define YAW_CONTROL_ZERO_TURN_EPSILON_PPS 0.0f
...
static void yaw_angle_control_configure_speed_loop(void);
...
void YawAngleControl_Init(uint32_t now_ms)
{
    ...
    yaw_angle_control_configure_speed_loop();
}
...
void YawAngleControl_Task(uint32_t now_ms)
{
    ...
    if (elapsed_ms > YAW_CONTROL_DT_CLAMP_MS) {
        elapsed_ms = YAW_CONTROL_UPDATE_MS;
    }
    ...
    if ((g_yaw_state.error_deg == 0.0f) ||
        (yaw_angle_control_abs(turn_speed_pps) <
            YAW_CONTROL_ZERO_TURN_EPSILON_PPS)) {
        turn_speed_pps = 0.0f;
