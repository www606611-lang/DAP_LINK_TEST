...
The UART2 transport sends eight `0x55` training bytes and a synchronization
line before each TX burst. The tuner discards that training line before forwarding
